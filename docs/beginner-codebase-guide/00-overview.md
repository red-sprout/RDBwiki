...
- 문서 내 MySQL/PostgreSQL/Oracle 섹션과 SQL 예시 필터: `lib/dbms-filter.ts`, `components/docs/DbmsSectionFilter.tsx`
- SQL 코드 하이라이팅과 DBMS 라벨 표시: `components/docs/SqlCodeBlock.tsx`, `components/docs/MarkdownRenderer.tsx`
- DBMS별 문서 목록과 상세 자동 선택 링크: `app/dbms/[dbms]/page.tsx`
...
- DBMS 필터: 문서 본문 중 특정 DBMS h2 섹션과 SQL 예시만 골라 보는 기능입니다.
- SQL dialect 추론: 범용 `sql` 코드블록을 MySQL/PostgreSQL/Oracle 예시로 추정해 라벨과 필터링에 쓰는 규칙입니다.
